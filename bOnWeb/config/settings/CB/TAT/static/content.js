...
window.appContent = (function() {
	...
	var brands = {
		...
		YB: {
			...
			faqsSavingsLink: 'https://help.cybonline.co.uk/system/selfservice.controller?CONFIGURATION=1181&PARTITION_ID=1&CMD=STARTWELCOMEPAGE&USERTYPE=1&isSecure=true&isSecure=true&LANGUAGE=en&COUNTRY=us',
	...
	var result = {
		...
		noUnplannedBorrowing: 'Borrowing is not available on this account. Requests for unplanned borrowing will usually be declined. Full details can be found in the Borrowing section of your Terms and Conditions and in your Tariff.',
		...
		// Key Features B
		serviceCommitmentB: 'We\'re committed to providing our customers with the best possible service from us but more information can be found in the Terms and Conditions about what to do if you have a complaint.',
		...
		packagedAccountOpening: 'Both a current account and a linked savings account must be opened at the same time, please see Terms and Conditions for full details.',
		...
		noticeOfChanges: 'We will usually give you two months\' notice of changes, the Terms and Conditions detail any that we may make sooner.',
		...
		reviewTopParagraph: 'Please review what you\'ve told us and if necessary edit any of the information you\'ve provided. Please ensure you read all the important information including key features, terms and conditions and tariff.  When you\'re ready, submit. We\'ll take care of the rest.',
		...
		termsAndConditionsDocLinkTitle: 'Download Terms and Conditions document PDF. This link will open in a new browser window.',
		...
		reviewAcceptTsAndCsBullet1: 'I wish to apply for the account',
		reviewAcceptTsAndCsBullet2: 'I have read and accept the Terms & Conditions and Tariff. I have also saved or printed a copy of the Terms & Conditions and Tariff',
		reviewAcceptTsAndCsBullet3: 'I acknowledge receipt of the Financial Services Compensation Scheme Information Sheet',
		...
		reviewAcceptTsAndCsBullet5: 'If my application is accepted and I proceed to open the account, I authorise you to debit to the account all cheques, orders, payments and withdrawals signed or otherwise authorised by me. I also authorise you to debit to the account all transactions made by using any debit cards that you may issue to me',
		reviewAcceptTsAndCsBullet6: 'I authorise you to undertake any necessary searches required to validate my identity and address, and',
		reviewAcceptTsAndCsBullet7: 'If my application is accepted and I proceed to open the account, I authorise you to debit to the account all withdrawals signed or otherwise authorised by me.',
		reviewAcceptTsAndCsBullet8: 'If my application is accepted and I proceed to open the account, I authorise you to debit to the account all withdrawals signed or otherwise authorised by me. I also authorise you to debit to the account all transactions made by using any debit cards that you may issue to me',
		...
		offerItemCancelation: 'You can cancel your agreement with us within 14 days of opening the account, or from the day you receive the Terms and Conditions if later, by contacting us in branch, phone or in writing. You will need to repay any debit balance, interest and fees incurred within 30 days from the date you tell us you want to cancel it.',
		...
		offerItemnonContactlessCard: 'Non-Contactless debit card',
		...
		offertandCCondition: 'I wish to apply for this account',
		offertandCCondition2: 'I have read and accept the Terms & Conditions and Tariff. I have also saved or printed a copy of the Terms & Conditions and Tariff',
		...
		offerDebitAuthCondition2: 'If my application is accepted and I proceed to open the account, I authorise you to debit to the account all withdrawals signed or otherwise authorised by me. I also authorise you to debit to the account all transactions made by using any debit cards that you may issue to me',
		...
		idDeferredLinkTitle: 'Download ID Requirements PDF. This link will open in a new browser window',
		...
		usernameValidationMessage: 'Your Customer Number should be a 10 digit number starting with "10". Your Username should be between 6 and 16 characters. It can be made up of letters and numbers and is case sensitive. If you are having difficulty finding these, please call us on ' + brand.phoneNumber + '.',
		...
		switchFullTsAndCsDocLinkTitle: 'Download Current Account Switch Services Terms and Conditions PDF. This link will open in a new browser window.',
		...
		sortCodeHelpMessage: 'Your Sort Code is a 6 digit number starting with "82". It will appear on the front of your debit card.',
