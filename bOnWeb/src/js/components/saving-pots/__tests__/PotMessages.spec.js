...
const shallowRender = props => {
	...
	shallowRenderer.render(<PotMessages
						   {...props}
						/>);
	return shallowRenderer.getRenderOutput();
};

describe('PotMessages Test Cases check', () => {	
		beforeEach(() => {
		});

		it("PotMessages : Unit Test Case 1 : toBeDefined",()=>{
		props = {
			isChanged : true,
			amountvalue: 0, 
              goal:1234,
		...
		it("PotMessages : Unit Test Case 2 : Goal! ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 0,
              goal:1234,
	...
	it("PotMessages : Unit Test Case 3 : Goal! ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 0,
              goal:1000,
	...
	it("PotMessages : Unit Test Case 5 : It might take a while",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 200,
              goal:1000,
	...
	it("PotMessages : Unit Test Case 6 : Way to go",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 270,
              goal:1000,
	...
	it("PotMessages : Unit Test Case 7 : You'll smash it",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 350,
              goal:1000,
	...
	it("PotMessages : Unit Test Case 8 : check it ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : null,
              goal:1000,
	...
	it("PotMessages : Unit Test Case 9",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 3600,
              goal:10001,
	...
	it("PotMessages : Unit Test Case 11",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : null,
              goal:0,
	...
	it("PotMessages : Unit Test Case 12",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 300,
              goal:600,
	...
	it("PotMessages : Unit Test Case 13",()=>{
		props = { 
			  amountvalue : 700,
              goal:600,
              goalwhen : '2017-10',
	...
	it("PotMessages : Unit Test Case 4 : That's spot on ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 176.93,
              goal:2300,
	...
	it("PotMessages : Unit Test Case 14",()=>{
		props = { 
			  amountvalue : NaN,
              goal:'£',
              goalwhen : '2017-10',
...
describe('PotMessages ££££',()=>{

	it("PotMessages : Unit Test Case 40 : That's spot on ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 176.93,
              goal:2300,
...
describe('PotMessages $$$',()=>{
	...
	it("PotMessages : Unit Test Case 41 : That's spot on ",()=>{
		props = { 
			  isChanged : true,
			  amountvalue : 1000,
              goal:1000,
