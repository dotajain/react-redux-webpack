jest.unmock('../MobileViewTransactionHistoryGrid');
...
const shallowRender = props => {
    ...
    shallowRenderer.render(<MobileViewTransactionHistoryGrid {...props} />);
...
describe('TransactionHistoryGrid Test Cases check', () => {
    ...
    let component = TestUtils.renderIntoDocument(
        <MobileViewTransactionHistoryGrid  {...props}
            />
    );
    ...
    it('should run onShowProgressIconClick', () => {
        let row = false;
        component.onShowProgressIconClick(row);
    });

    it('should run callTransactionTagFun', () => {
        let tag = 'tag';
        let rowData = 'rowData';
        component.callTransactionTagFun(tag, rowData);
    });

    it('should run callTransactionTagFun where tag = untagged', () => {
        let tag = 'Untagged';
        let rowData = 'rowData';
        component.callTransactionTagFun(tag, rowData);
    });

    it('should run callTransactionBalanceFun', () => {
        let balance = true;
        component.callTransactionBalanceFun(balance);
    });
    ...
    xit('should run onRowSelectAll fxn ', () => {
    ...
    xit('should run onSortChange fxn when sort = desc', () => {
        let sortName = 'date';
        let sort = 'desc';
        component.onSortChange(sortName, sort);
    });

    xit('should run onSortChange fxn when sortName != date', () => {
        let sortName = '';
        let sort = 'desc';
        component.onSortChange(sortName, sort);
    });

    xit('should run onSortChange fxn when sortName = description', () => {
    ...
    xit('should run callTransactionBalanceFun fxn', () => {
        let props = {
            data: [{ id: 1 }, { id: 2 }],
            onShowProgressIconClick: jest.fn(),
            openSideBar: jest.fn(),
    ...
    xit('should run callTransactionBalanceFun fxn when data is undefined', () => {
        let props = {
            data: undefined,
            onShowProgressIconClick: jest.fn(),
            openSideBar: jest.fn(),
    ...
    xit('should run callTransactionTagFun fxn when data = undefined', () => {
        let props = {
            data: undefined,
            rowData: {
                city: 'city',
    ...
    xit('should run amountFormatter fxn', () => {
        let props = {
            data: [{ id: 1 }, { id: 2 }],
            rowData: {
                city: 'city',
    ...
    xit('should run amountFormatter fxn when data = undefined', () => {
        let props = {
            data: undefined,
            rowData: {
                city: 'city',
    ...
    xit('should run getGridComponent fxn', () => {
        component.getGridComponent();
    });

    xit('should run render fxn', () => {
