...
window.appContent = (function() {
	...
	var result = {
		...
		monthlyFee: 'A Monthly Maintenance Fee of Â£2 applies to the B banking service and will be applied following a 12 month free period. Full details can be found in your Terms and Conditions and Tariff.',
		...
		interestUpTo3000: 'Interest is payable on this account on credit balances up to Â£3000.',
		noUnplannedBorrowing: 'Borrowing is not available on this account. Requests for unplanned borrowing will usually be declined. An item returned unpaid costs Â£15. Full details can be found in the Borrowing section of your Terms and Conditions and in your Tariff.',
		plannedBorrowing125: 'Planned borrowing is available on this account, subject to eligibility. The cost of this is Â£6 per month plus interest. Requests for unplanned borrowing will usually be declined. Full details can be found in the Borrowing section of your Terms and Conditions and in your Tariff.',
		plannedBorrowing: 'Borrowing is available on this account, subject to eligibility, and is usually more expensive if not agreed in advance. Planned borrowing costs Â£6 per month plus interest. Unplanned borrowing costs Â£6 per day. An item returned unpaid costs Â£15. Full details can be found in the Borrowing section of your Terms and Conditions and in your Tariff.',
		fscsCovered: 'Your eligible deposits with Clydesdale Bank PLC are protected up to a total of Â£75,000 by the Financial Services Compensation Scheme, the UK\'s deposit guarantee scheme. This limit is applied to the total of any deposits you have with Clydesdale Bank, Yorkshire Bank and B. Any total deposits you hold above the limit between these brands are unlikely to be covered. Please see <a href="http://www.cbonline.co.uk/resources/b82e172a-b00f-4783-973b-e4399da349e4/fscs_2015_online-leaflet.pdf" target="_blank" title="www.fscs.org.uk. This link will open in a new browser window">FSCS leaflet<span class="screenreader"> This link will open in a new browser window</span></a> for further information or visit <a href="http://www.fscs.org.uk" target="_blank" title="www.fscs.org.uk. This link will open in a new browser window">www.fscs.org.uk<span class="screenreader"> This link will open in a new browser window</span></a>',
		...
		caDirectKeyFeature: 'This account requires a minimum deposit of Â£1000 per month (excluding transfers from other accounts held with us), and that you must register for telephone and internet services and use these for day-to-day banking. Please note, if you fail to meet these criteria, we may change your account to a Current Account Plus which has different interest rates.',
		...
		overdraftFacilityB: 'Borrowing is available on the B Current account, subject to eligibility.  Going overdrawn is usually more expensive if not arranged in advance. Planned borrowing costs Â£6 per month plus interest. Unplanned borrowing costs Â£6 per day. An item returned unpaid costs Â£15. Full details can be found in your Terms and Conditions and in your Tariff. Borrowing is not allowed on the B Instant Savings account.',
		...
		noticeOfChanges: 'We will usually give you two monthsâ€™ notice of any changes. The Terms and Conditions detail any that we may make sooner.',
		...
		selectBankSubtitle: 'Youâ€™ll be able to manage your account online and you can call us too, but if you ever need to see us in person use the links below to find your nearest branch now.',
		...
		selectBankHelpText: 'For CHAPS and international payments, plus some other transaction types, youâ€™ll have to visit your local branch.',
		...
		usernameInfo: 'When you create your username and password make sure theyâ€™re memorable, as you\'ll need them to log on in future, for internet banking and signing up to the B app. The username you choose can\'t be changed and team at B won\'t be able to remind you of it if you forget it.',
		...
		employmentStartDateValidationMessage: 'Sorry, your employment date doesnâ€™t seem right. Try again?',
		...
		grossAnnualIncomeValidationMessage: 'Keep it simple please. No dots, commas or even a Â£.',
		...
		netMonthlyIncomeValidationMessage: 'Keep it simple please. No dots, commas or even a Â£. If your income goes up and down just type in an average. Your monthly income shouldnâ€™t be more than your annual income divided by 12.',
		...
		reviewTopParagraph: 'Please double-check that your contact details are all correct in the summary below. Some youâ€™ll be able to edit yourself but if anything\'s not quite right please call the team at B on ' + brand.phoneNumber + ' and ask them to make changes for you. ',
		...
		offerItemWithInterest: 'Ongoing 2% AER (variable) interest on balances up to Â£3000',
		...
		offerItemDebitContactlessLimited: 'A Debit MasterCard Online Only card for your B Current Account with Contactless functionality allowing you to withdraw up to Â£350 a day at any UK ATM, subject to available funds.',

		offerItemCaControl: 'A Debit MasterCard Online Only card with Contactless functionality allowing you to withdraw up to Â£350 a day at any UK ATM, subject to available funds.',
		// ready cash offers
		offerItemReadyCash: 'A Debit MasterCard Online Only card with Non contactless functionality allowing you to withdraw up to Â£350 a day at any UK ATM, subject to available funds.',
		...
		offerItemDebitCard: 'You will receive a Debit MasterCard Online Only card with non contactless functionality allowing you to withdraw up to Â£350 a day at any Clydesdale ATM or UK ATM, subject to available funds.',
		offerItemDeposits: 'Your eligible deposits with Clydesdale Bank PLC are protected up to a total of Â£75,000 by the Financial Services Compensation Scheme, the UKâ€™s deposit guarantee scheme. This limit is applied to the total of any deposits you have with Clydesdale Bank, Yorkshire Bank and B. Any total deposits you hold above the limit between these brands are unlikely to be covered. Please see <a href="http://www.cbonline.co.uk/resources/b82e172a-b00f-4783-973b-e4399da349e4/fscs_2015_online-leaflet.pdf" target="_blank" title="www.fscs.org.uk. This link will open in a new browser window">FSCS leaflet<span class="screenreader"> This link will open in a new browser window</span></a> for further information or visit <a href="http://www.fscs.org.uk" target="_blank" title="www.fscs.org.uk. This link will open in a new browser window">www.fscs.org.uk<span class="screenreader"> This link will open in a new browser window</span></a>',
		...
		offerPageUnsuccessfulTitle: 'We are sorry, it appears that you are not eligible for the {productTitle} as you donâ€™t hold the appropriate current account',
		...
		// Savings Pot
		savingConfHeader: 'Thank You',
		savingDone:'Done',
		savingRegular:'Or setup a regular transfer?',
		savingOff:'Want to make a one-off payment to kick start it now?',
		SavingsAcc:'Savings account',
		SavingLinkPot:'Want to create a new Savings pot?',
		SavingPotDefaultMessage:'Savings Pots are a way of saving for the things you’ve always wanted. You can tailor your pots using our calculator, to make them work within your budget. Then keep up to date with your progress and make edits as things change, as they always do! To use Savings Pots, you need to open a B Savings Account',
		...
		savingpotmessage:'Savings Pots are a way of saving for the things you have always wanted. You can tailor your pots using our calculator, to make them work within your budget. Then keep up to date with your progress and make edits as things change as they always do',
		...
		nbaHeader:'Mortgage Payment Tips',
		nbaBody:'Did you know you can change your mortgage payment date? Call us on '+ brand.phoneNumber +' to find out more.',
        createpotbutton :'Create Pot',
		cancelbutton:'Cancel',
		backButton:'Back',
		saveButton:'Save',
		savingsPotNameLabel:'Savings Pot Name',	
		yesbutton:'Yes',
		...
		deletePotButton:'Delete Savings Pot',
		confirmationCancel:'Great. Your Savings Pot has been created',
		confirmationTransfer:'Want to make a one-off transfer to kick start it now?',
		confirmationTransferRegular:'Or Set up a regular transfer?',
		moveMoneyButton:'Move Money',
		editPotButton:'Edit Savings Pot',
		reduceRejigButton:'Reduce or delete Savings Pots',
		moveMoneyButton2:'Move money into my savings account',
		potCurrencyType:'GBP',
		createSavingPotHeading: 'Create Savings Pot in',
		editSavingPotHeading: 'Edit my Savings Pot in',
		dateDefaultText: 'Choose...',
		potUnallocatedText: 'unallocated',
		wayToGoHead:'Way to go',
		...
		registrationPageParagraph2CYB: 'For Telephone Banking you\'ll need your customer number â€“ again it\'s above, and your telephone PIN â€“ which you can set up below.',
		...
		accountOpenedSection3Bullet1: 'Arrange to include your B accounts in mortgage offsetting arrangements (this won\â€™t be done automatically)',
		...
		accountOpenedSection1Bullet2CYB: 'Youâ€™re all registered for internet banking too. You can use this straight away by going to the login button at the top right of any page on <a href="' + brands.CB.bankWebsite + '" target="_blank" title="www.cbonline.co.uk This link will open in a new browser window">www.cbonline.co.uk <span class="screenreader">This link will open in a new browser window</span></a> or <a href="' + brands.YB.bankWebsite + '" target="_blank" title="www.ybonline.co.uk This link will open in a new browser window">www.ybonline.co.uk <span class="screenreader">This link will open in a new browser window</span></a>. You\'ll need your customer number, password and security details.',
		accountOpenedSection2TitleCYB: 'Look out for your post',
		accountOpenedSection2Bullet1CYB: 'You will receive a welcome letter which will confirm the details of your new account, please read through and send us back your specimen signature, as weâ€™ll need this so you can make certain transactions on your account',
		...
		switchPageText3CYB: '<strong>Once your switch has started it cannot be stopped</strong>, but the guarantee means that if anything goes wrong weâ€™ll refund any interest or charges made on either your old account or the new one as a result.',
		...
		switchDetailsTitleCYB: 'Please fill in the following details. Use the details from the old account youâ€™re switching from, and not the new one youâ€™ve just opened.',
		...
		switchCode366: 'The sort code, account number or 16-digit card number youâ€™ve entered arenâ€™t quite right. Please give them a double-check and try again.',
		...
		switchCode393: 'Thereâ€™s been a problem with B, please try again later or call the team on ' + brand.phoneNumber + ' to get this sorted.',
		...
		authDateOfBirthHelpMessage: 'Click on the month/year to start entering your dates. Thereâ€™s no need to scroll. The date entered should be formatted DD-MM-YYYY.',
		...
		accessCodeHelpMessage: 'This is your four-digit Access Account Number. Itâ€™s set during the registration process to allow you to access telephone banking and internet banking.',
		...
		datePickerHelpMessageSuffix: 'Click on the month/year to start entering your dates. Thereâ€™s no need to scroll. The date entered should be formatted DD-MM-YYYY.',
		newBrowserWindowTitle: 'This link will open in a new browser window.',

		//feature 4
		//Financial Stories & Projection	
		MicroTransaction:"micro",
		Cashpoint:"cashpoint",
		InAndOut:"inandout",
		...
		tile3Header:'Youâ€™ve taken out in cash so far this month ',
		tile3Footer:'Take a closer look...',
		tile4Header:'Nothingâ€™s in or out of your account so far',
		tile4Footer:'Take a closer look...',
		tile4HeaderNoData:'We canâ€™t show you this story right now',
		tile4FooterNoData:'Weâ€™ll keep trying thoughâ€¦',
		...
		AccountMoreInfoView_AvailableBalanceDisclaimer:'This balance may also include items that havenâ€™t gone through yet.',
		AccountMoreInfoView_AvailableBalanceDisclaimer_WithOverdraft:'This balance, which includes any overdraft, may also include items that havenâ€™t gone through yet.',
		AccountMoreInfoView_ContactMessage:'If youâ€™d like to talk about this account, please call the team at B on 0800 1217365.',
		prevSlide:'◀︎',
		nextSlide:'▶︎',
		helpButton:'Help',
		//tag
		deleteTagHeader:'Delete this tag?',
		deleteTagContent:'Youâ€™ll still be able to see it on your transactions,but you wonâ€™t be able to use it in the future.Still happy to delete?', 
		...
		tagSidebarContent:'Start by choosing your transaction(s) you wnat to tag,selecting one type only(like Groceries or Fuel).',
		...
		// sweeps
		sweepLine1: 'In my',
		sweepLine2: 'when I have less than',
		sweepLine3: 'sweep money from my',
		sweepLine4: 'to meet my target of',
		poundSymbol: '£',
		infoPopupContent: 'You can set up Sweeps to move from your B Instant Savings acount to your B Current Account. They can help you avoid charges but remember, they’re just automatic transfers, so will only work if there is enough money in your B Instant Savings account - eg you can set up a 					sweep to add £150 to your B Current Account every time it gets below £50 but it will only sweep that if you have the £150 in your B Instant Savings Account. Make Sense? They can take a tenny bit of time to shoe on your account but you’ll get a text each time a Sweep happens, 				even if it’s at the weekend. And you can change your Sweep settings any time you like.',
		...
		createMySweep:'Create my sweep',
		editMySweep:'Edit my sweep',
		doneButton:'Done',
		...
		createMyAlerts: 'Create My Alerts',
		editMyAlerts: 'Edit My Alerts',
		alertLine1: 'In my',
		whenIHave: 'when I have',
		than: 'than',
		send: 'send',
		sendAlert: ' me an alert via',
		sms: 'SMS',
		maxAlertPopupHead: 'An alert about your alerts',
		maxAlertPopupData: 'You can only have one high and one low balance alert per account. But you can edit your existing alerts.',

		// Projection
		projectionLine2:'projected balance below',
		projectionLine3:'send me an alert via',
		projectionLine4:'SMS',
